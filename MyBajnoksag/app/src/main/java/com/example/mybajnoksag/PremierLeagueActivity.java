...
public class PremierLeagueActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items = firestore.collection("PremierLeagueTeams");
        getTeams();
//        initializeData();
    }
...
//                initializeData();
    ...
    public void addTeam(View view) {
        ...
        if(Integer.parseInt(newTeamPoints) < 10){
            ...
            Toast.makeText(PremierLeagueActivity.this, "Sikertelen csapat hozzáadás: Ebben a szakaszban már legalább 10 pontja kell hogy legyen a csapatnak", Toast.LENGTH_LONG).show();
        }else{
            Log.d(LOG_TAG, "Sikeres csapat hozzáadás");
            Toast.makeText(PremierLeagueActivity.this, "Sikeres csapat hozzáadás, lépj vissza majd nyisd meg megint a ligát hogy lásd az új csapatod", Toast.LENGTH_LONG).show();
            items.add(new Team(
                    newTeamName,
                    newTeamWin,
                    newTeamDraw,
