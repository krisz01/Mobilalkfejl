...
public class LaligaActivity extends AppCompatActivity {
    private static final String LOG_TAG = LaligaActivity.class.getName();
...
//
//        if(user != null){
//            Log.d(LOG_TAG, "Regisztált felhsználó");
//        } else {
//            Log.d(LOG_TAG, "Nem regisztrált felhasználó");
//            finish();
//        }
        ...
        items = firestore.collection("LaligaTeams");
        getTeams();
//        initializeData();
    }
...
//                initializeData();
    ...
    public void addTeam(View view) {
        ...
        if(Integer.parseInt(newTeamPoints) < 10){
            ...
            Toast.makeText(LaligaActivity.this, "Sikertelen csapat hozzáadás: Ebben a szakaszban már legalább 10 pontja kell hogy legyen a csapatnak", Toast.LENGTH_LONG).show();
        }else{
            Log.d(LOG_TAG, "Sikeres csapat hozzáadás");
            Toast.makeText(LaligaActivity.this, "Sikeres csapat hozzáadás, lépj vissza majd nyisd meg megint a ligát hogy lásd az új csapatod", Toast.LENGTH_LONG).show();
            items.add(new Team(
                    newTeamName,
                    newTeamWin,
                    newTeamDraw,
